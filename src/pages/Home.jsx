...
function Home() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#393E46] flex flex-col">
      {/* Header */}
      <div className="w-full bg-[#222831] text-[#DFD0B8]">
        <div className="h-16 md:h-20 px-4 md:px-8 flex items-center justify-between max-w-7xl mx-auto">
          {/* Logo centrado en móvil, izquierda en desktop */}
          <h1 className="text-2xl md:text-4xl font-medium mx-auto md:mx-0">
            UniGo
          </h1>
        ...
        {showMobileMenu && (
          <div className="md:hidden bg-[#222831] border-t border-[#393E46] relative z-30">
            <div className="px-4 py-3 space-y-3">
              ...
              <button
                ...
                className="w-full text-left px-3 py-3 text-[#DFD0B8] hover:bg-[#393E46] rounded-md transition-colors duration-200 cursor-pointer"
              >
                Cerrar sesión
              </button>
            </div>
      ...
      {/* Ciclos Grid */}
      <div className="flex-1 w-full px-4 md:px-8 py-8">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 lg:gap-8">
            <a
              href="#"
              className="bg-[#222831] text-[#DFD0B8] text-center p-4 md:p-6 rounded-md hover:bg-[#202327] transition-colors duration-200 font-medium"
            >
              Ciclo 1
            </a>
            <a
