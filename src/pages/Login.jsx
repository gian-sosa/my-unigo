    ...
    <div className="min-h-screen theme-bg-gradient flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="theme-card-bg border theme-card-border rounded-3xl shadow-2xl p-8">
          ...
          {sessionError && (
            <div className="w-full bg-red-50 border border-red-200 rounded-xl p-4 mb-8">
              <div className="flex items-start gap-3">
          ...
          <div className="space-y-6">
            <button
              ...
              disabled={isLoading}
              className={`w-full bg-white hover:bg-gray-50 border-2 border-gray-200 hover:border-gray-300 text-gray-700 font-semibold p-4 rounded-xl transition-all duration-200 flex items-center justify-center gap-3 shadow-lg hover:shadow-xl ${
                isLoading
